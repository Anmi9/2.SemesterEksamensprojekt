...
Med henblik på vores forretningslogik, skal vi i vores lås sikre os, at kun en bruger kan booke et køretøj ad gangen, men samtidig skal bookingen ske hurtigt og effektivt. Vores valg af SemaphoreSlim er en effektiv løsning, da den er kompatibel med vores asynkrone metoder i modsætning til en synrkon semaphore eller fx en lock. En SemaphoreSlim laver en kø, men i stedet for at lade trådene vente, bliver de frigivet, så de kan udføre andre opgaver.
